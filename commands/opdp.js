...
module.exports = (client, message, args) => {
  ...
  if (initParse.includes('Incity')) {
    if (initParse.includes('Peasants')) {
      ...
      console.log(pezArr);
      if(pezArr.includes('Inarmy') && pezArr.length==10){
        U6[0] = parseInt(pezArr[2]);
        U6[1] = parseInt('0');
        U6[2] = parseInt(pezArr[4]); 
      }
      else if(pezArr.includes('Incity') && pezArr.length==4){
        U6[0] = parseInt(pezArr[1]);
        U6[1] = parseInt('0');
        U6[2] = parseInt(pezArr[3]);
      }
      else if(pezArr.includes('Incity') && pezArr.length==5){
        U6[0] = parseInt(pezArr[2]);
        U6[1] = parseInt('0');
        U6[2] = parseInt(pezArr[4]);
      }
      else if(pezArr.length == 8){
        U6[0] = parseInt(pezArr[1]);
        U6[1] = parseInt('0');
        U6[2] = parseInt(pezArr[3]);
      }
      else if(pezArr.includes('Inarmy') && pezArr.length!==10){
        U6[0] = parseInt('0');
        U6[1] = parseInt('0');
        U6[2] = parseInt('0');
      }
